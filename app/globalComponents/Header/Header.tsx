...
export default function Header() {
    const [isMouseOnGit, setIsMouseOnGit] = useState<boolean>(false);
                ...
                <ul className="flex gap-10 pr-16 items-center">
                    <li>
                        <Link
                            ...
                            onMouseLeave={() => setIsMouseOnGit(false)}
                            className="block w-6 h-6 relative">
                            <svg
                                className={`transition duration-500 ${
                                    isMouseOnGit ? "opacity-0" : "opacity-100"
                                }`}
                                fill="#fff"
                                role="img"
                                viewBox="0 0 24 24"
                            ...
                            <svg
                                className={`transition absolute top-0 duration-500 ${
                                    isMouseOnGit ? "opacity-100" : "opacity-0"
                                }`}
                                fill="#46e683"
                                role="img"
                                viewBox="0 0 24 24"
                    ...
                    <li>
                        {username ? (
                            ...
                            <Link
                                href="../../logreg"
                                className="text-white underline block p-3 transition-all hover:text-third">
                                Sign in
                            </Link>
                        )}
                    </li>
